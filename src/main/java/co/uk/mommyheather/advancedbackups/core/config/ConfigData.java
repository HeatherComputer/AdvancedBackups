...
public class ConfigData {
    ...
    Object size, Object min, Object max,
    Object uptime, Object schedule, Object shutdown,
    Object startup, Object delay, Object silent,
    Object compression, Object chainLength, Object compressChains,
    Object smartChains, Object maxPercent, Object purgeIncrementals) {
        return String.join("\n",

"#Enable or disable automatic backups.",
"#Options : true, false   #Default : true,",
"config.advancedbackups.enabled=" + enabled,
"",
"#Whether to save before making a backup.",
"#Options : true, false    #Default : false",
"config.advancedbackups.save=" + save,
"",
"#Whether to require player activity between backups.",
"#Options : true, false    #Default : false",
"config.advancedbackups.activity=" + activity,
"",
"#The type of backups to use.",
"#Options : zip, differential, incremental    #Default : differential",
"config.advancedbackups.type=" + type,
"",
"#The absolute or relative path to the backup location.",
"#Options : any file path. Default : ./backups",
"config.advancedbackups.path=" + location,
"",
...
"config.advancedbackups.size=" + size,
"",
...
"config.advancedbackups.frequency.min=" + min,
"",
"#Triggers a backup if none has already happened within this time. Can be combined with an uptime-based schedule.",
"#Range : 0.5 - 500    #Default : 24",
"config.advancedbackups.frequency.max=" + max,
"",
"#Whether the schedule below uses uptime (true) or real-world time (false).",
"#Default : true",
"config.advancedbackups.frequency.uptime=" + uptime,
"",
...
"#Range : 1-9    #Default : 4",
"config.advancedbackups.zips.compression=" + compression,
"",
"",
"",
"#--------------------------------------------------------------------------------------------------------------------",
...
"config.advancedbackups.chains.length=" + chainLength,
"",
...
"#Options : true, false    #Default : true",
"config.advancedbackups.chains.compress=" + compressChains,
"",
...
"#Options : true, false    #Default : true",
"config.advancedbackups.chains.smart=" + smartChains,
"",
...
"config.advancedbackups.chains.maxpercent=" + maxPercent,
"",
...
"#Options : true, false    #Default : false",
"config.advancedbackups.purge.incrementals=" + purgeIncrementals
